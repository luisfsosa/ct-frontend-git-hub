...
@Component({
  selector: "app-beneficiary-client-form",
  templateUrl: "./beneficiary-client-form.component.html",
  styleUrls: ["./beneficiary-client-form.component.scss"]
})
export class BeneficiaryClientFormComponent implements ModalComponent<FormState> {
  context: FormState;
  formData = {
      codigo: "",
      nombre: ""
