...
@Component({
  selector: "app-institutional-client-form",
  templateUrl: "./institutional-client-form.component.html",
  styleUrls: ["./institutional-client-form.component.scss"]
})
export class InstitutionalClientFormComponent implements ModalComponent<FormState> {
  context: FormState;
  formData = {
      codigo: "",
      nombre: ""
