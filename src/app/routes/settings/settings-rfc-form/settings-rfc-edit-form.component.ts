...
@Component({
  selector: "app-settings-rfc-edit-form",
  templateUrl: "./settings-rfc-edit-form.component.html",
  styleUrls: ["./settings-rfc-form.component.scss"]
})
export class SettingsRfcEditFormComponent implements OnInit {
  context: any;
  formData = {
    id:0,
    codigo_parametro: "",
  ...
  saveForm(){
    SettingsValidator.update(RFC, this.formData,this._User.getClient(),this.dialog, this._WS, this.pubsub, this.toastr );
  }
}
