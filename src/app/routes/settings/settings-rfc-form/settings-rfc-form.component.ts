...
import {RFC}  from "../settings.constants";


@Component({
  selector: "app-settings-rfc-form",
  templateUrl: "./settings-rfc-form.component.html",
  styleUrls: ["./settings-rfc-form.component.scss"]
})
export class SettingsRfcFormComponent implements ModalComponent<FormState> {
  context: FormState;
  formData = {
    codigo_parametro: "",
  ...
  saveForm() {
    SettingsValidator.create(RFC, this.formData, this._User.getClient(),this.dialog, this._WS, this.pubsub, this.toastr );
  }
}
