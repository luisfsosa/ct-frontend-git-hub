...
@Component({
  selector: "app-settings-global-form",
  templateUrl: "./settings-global-form.component.html",
  styleUrls: ["./settings-global-form.component.scss"]
})
export class SettingsGlobalFormComponent implements ModalComponent<FormState> {
  context: FormState;
  formData = {
    codigo_parametro: "",
  ...
  saveForm() {
    SettingsValidator.create(GLOBAL, this.formData, this._User.getClient(),this.dialog, this._WS, this.pubsub, this.toastr );
  }
}
