...
@Component({
  selector: "app-settings-dispatching-edit-form",
  templateUrl: "./settings-dispatching-edit-form.component.html",
  styleUrls: ["./settings-dispatching-form.component.scss"]
})
export class SettingsDispatchingEditFormComponent implements OnInit {
  context: any;
  formData = {
    id:0,
    codigo_parametro: "",
  ...
  saveForm(){
    SettingsValidator.update(DISPATCHING, this.formData,this._User.getClient(),this.dialog, this._WS, this.pubsub, this.toastr );
  }
}
