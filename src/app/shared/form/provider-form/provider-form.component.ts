import {FormState, toDatePicker, getEmptyDatePicker,getCurrentDate} from '../util/form-state';
import {
  FormGroup,
  Validators,
} from "@angular/forms";
...
export class ProviderFormComponent implements ModalComponent<FormState> {
  context: any;
  formData = {
      rfc_fuente: "",
  ...
  private onSave() {
    ...
    this.toastr.success("Se guardó un nuevo Proveedor");
